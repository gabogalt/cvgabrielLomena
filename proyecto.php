...
if (isset($_SESSION['idUsuario']) && !empty($_SESSION['idUsuario'])){
	...
	$consulta = " SELECT nombreCliente, nombreProyecto, numeroOrden from proyectos where idUsuario='$idUsuario'";
	...
	<div class="container-fluid" id="wrapper">
		<div class="row">
			<!-- <nav class="sidebar col-xs-12 col-sm-4 col-lg-3 col-xl-2">
				...
				<li class="nav-item"><a class="nav-link active" href="index.php"><em class="fa fa-dashboard"></em> Inicio <span class="sr-only">(current)</span></a></li>					<li class="nav-item"><a class="nav-link" href="proyecto.php"><em class="fa fa-calendar-o"></em> Proyectos</a></li>
					<li class="nav-item"><a class="nav-link" href="nuevoProyecto.php"><em class="fa fa-pencil-square-o"></em> Nuevo Proyecto</a></li>
					<li class="nav-item"><a class="nav-link" href="cards.html"><em class="fa fa-clone"></em> Perfil</a></li>
				</ul>
			...
			<nav class="sidebar col-xs-12 col-sm-4 col-lg-3 col-xl-2">
				...
				<ul class="nav nav-pills flex-column sidebar-nav">
					...
					<li class="nav-item"><a class="nav-link active" href="proyecto.php"><em class="fa fa-calendar-o"></em> Proyectos</a></li>
					<li class="nav-item"><a class="nav-link" href="nuevoProyecto.php"><em class="fa fa-pencil-square-o"></em> Nuevo Proyecto</a></li>
			...
			<main class="col-xs-12 col-sm-8 col-lg-9 col-xl-10 pt-3 pl-4 ml-auto">
				<header class="page-header row justify-center">
					<div class="col-md-6 col-lg-8" >
						<h1 class="float-left text-center text-md-left">Proyectos</h1>
					</div>
									...
									<div class="card-block">
										...
										<div class="table-responsive">
											<table class="table table-striped">
												...
												?>	
													<tr>
														<td><?php echo $array['numeroOrden']; ?></td>
														<td><?php echo $array['nombreProyecto'];?></td>
														<td><?php echo $array['nombreCliente'];?></td>
														<td><a href="#"><i class=" pl-4 far fa-2x fa-envelope"></i></a></td>
                                                        <td><a href="editarProyecto.php?numeroOrden=<?php echo $array['numeroOrden']?>"><i class="fas fa-pencil fa fa-2x"></i></a></td>
														<td><a href="eliminarProyectos.php?numeroOrden=<?php echo $array['numeroOrden']?>"  ><i class="fas fa-trash-alt fa-2x" id="eliminar"></i></a></td>
